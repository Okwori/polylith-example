...
(def document-schema
  [(attr :document/industries :string :many "The industries ...")
   ...
   (attr :document/description :string :one "The description of the document")
   ...
   (attr :document/author_name :string :one "author_name ...")
   ...
   (attr :document/adversary :string :one "adversary ...")
   (attr :document/id :string :one "id ...")
   (attr :document/name :string :one "name ...")
